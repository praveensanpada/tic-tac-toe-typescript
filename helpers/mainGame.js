...
var mainHelpers_1 = require("./mainHelpers/mainHelpers");
var prompt = require("prompt-sync")({ sigint: true });
var mainHelpersObj = new mainHelpers_1.mainHelpers();
var mainGame = /** @class */ (function () {
    function mainGame() {
    }
    mainGame.prototype.main_game = function () {
        var select = prompt("\t\tChoose The Number.....\n\t\t1) Create a new game\n\t\t2) Join as player 2 in an existing game\n\t\t3) Be a spectator\n\t\t");
        switch (select) {
            case 1: {
